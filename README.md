...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-w-b23tq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-w-b23tq.containers.anotherwebservice.com/
...
```
git clone git@github.com:Trochez/container-w-b23tq.git
cd container-w-b23tq
```
...
```
docker attach container-w-b23tq
```
